...
namespace GSharp.Generated.LuaLibraries {
    ...
    public interface IMath {
        ...
        /// </summary>
        /// <returns>Type: number - absolute_value</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  acos</returns>
        ...
        /// </summary>
        /// <returns>Type: number - The difference between the angles between -180 and 180</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Modified angle</returns>
        ...
        /// </summary>
        /// <returns>Type: number - New current value, closer to the target than it was previously.</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  asin</returns>
        /// <param name='normal'>Value in range of -1 - 1.</param>
        ...
        /// </summary>
        /// <returns>Type: number - atan2</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  atan</returns>
        /// <param name='normal'>Value in range of -1 - 1.</param>
        ...
        /// </summary>
        /// <returns>Type: number - Base 10 number.</returns>
        ...
        /// </summary>
        /// <returns>Type: Vector - Point on Bezier curve, related to tDiff.</returns>
        ...
        /// </summary>
        /// <returns>Type: number - ceiled numbers</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  hcos</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Cosine of given angle</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  degrees</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Distance between the two points</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Eased Value</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  result</returns>
        ...
        /// </summary>
        /// <returns>Type: number - floored numbers</returns>
        ...
        /// </summary>
        /// <returns>Type: number - The calculated modulus.</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  normalizedFraction</returns>
        ...
        /// </summary>
        /// <returns>Type: string - Binary number string. The length of this will always be a multiple of 3.</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Logarithm of x to the given base</returns>
        /// <param name='x'>The value to get the base from exponent from.</param>
        ...
        /// </summary>
        /// <returns>Type: number - The largest number</returns>
        ...
        /// </summary>
        /// <returns>Type: number - The smallest number</returns>
        ...
        /// <param name='base'>The base value.</param>
        /// <param name='modulator'>The modulator.</param>
        void modf(double @base, double modulator);
        
        /// <summary>
        /// Normalizes angle, so it returns value between -180 and 180.
        /// </summary>
        /// <returns>Type: number - The normalized angle, in the range of -180 to 180 degrees.</returns>
        ...
        /// </summary>
        /// <returns>Type: number - y power of x</returns>
        ...
        /// </summary>
        /// <returns>Type: number - radians</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Random value</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Random float between min and max.</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  sinh</returns>
        /// <param name='number'>Value in radians.</param>
        ...
        /// </summary>
        /// <returns>Type: number - Sine for given angle</returns>
        /// <param name='number'>Angle in radians</param>
        ...
        /// </summary>
        /// <returns>Type: number - squareRoot</returns>
        ...
        /// </summary>
        /// <returns>Type: number -  tanh</returns>
        /// <param name='number'>Value in radians.</param>
        ...
        /// </summary>
        /// <returns>Type: number -  tangents</returns>
        ...
        /// </summary>
        /// <returns>Type: number - Fraction</returns>
        ...
        /// </summary>
        /// <returns>Type: number - The number in the new range</returns>
