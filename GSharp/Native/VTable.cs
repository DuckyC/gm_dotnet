...
{
    //Source: https://github.com/cartman300/Libraria/blob/b38562abe1c45bc0e05101f664816702c0d8f072/Libraria.Native/VTables/VTable.cs
    ...
    public class NativeMethodInfo
    {
        ...
        {
            return GetDelegate(typeof(T), Instance) as T;
        }

        public Delegate GetDelegate(Type DelegateType, IntPtr Instance)
        {
