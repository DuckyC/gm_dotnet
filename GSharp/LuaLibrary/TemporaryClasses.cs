namespace GSharp
{
    ...
    //    {
    //        Lua.lua_getglobal(LuaState, "file");
    //        Lua.lua_getfield(LuaState, -1, "Find");
    //        LuaAdvanced.Push(LuaState, name);
    //        LuaAdvanced.Push(LuaState, path);
    //        LuaAdvanced.Push(LuaState, sorting);
    //        Lua.lua_pcall(LuaState, 3, 2, 0);
    //        return LuaAdvanced.PopReturnType<IFileFindReturnType>(LuaState);
    //    }
